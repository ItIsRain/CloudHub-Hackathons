      ...
      <div className="container relative mx-auto px-4 py-8 sm:px-6 flex flex-col items-center justify-center">
        ...
        <div className="w-full max-w-md mx-auto">
          ...
          <Card className="border-none shadow-lg w-full bg-white/70 dark:bg-slate-900/70 backdrop-blur-md overflow-hidden">
            ...
            <CardContent className={`pt-5 ${isSubmitted ? "pb-4" : "pb-6"}`}>
              {isSubmitted ? (
                <div className="flex flex-col items-center justify-center space-y-5 py-6">
                  <div className="relative">
                    ...
                    <div className="relative rounded-full bg-gradient-to-br from-green-400 to-emerald-500 p-4 shadow-md">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <Input
                        ...
                        autoComplete="email"
                        autoCorrect="off"
                        className="pl-10 border-slate-200 dark:border-slate-700 focus:border-blue-500 group-hover:border-blue-500 transition-colors h-10"
                        disabled={isLoading}
                        value={email}
              ...
              <div className="w-full text-center">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  {isSubmitted ? (
                    <Button 
                      variant="link" 
                      className="p-0 text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-700 hover:to-indigo-700 underline-offset-4 font-medium"
                      onClick={() => {
